...
export default function About() {
  return (
    <div className="w-full pt-32 md:pt-28 pb-32">
      ...
      <div className="bg-white h-[85vh] mb-10" style={{ backgroundImage: `url('/assets/images/phantom-africa-image1.png')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <div className="w-full h-full bg-dark-900/50 backdrop-blur-sm flex items-center justify-center">
          <Reveal>
            <h1 className="text-5xl md:text-7xl lg:text-[6rem] font-display font-bold uppercase tracking-tighter leading-[0.9] text-white text-center">
      ...
      {/* MISSION & VISION */}
      <section className="mb-32 py-16 md:py-24 px-6 md:px-12 bg-dark-900/50 backdrop-blur-sm" style={{ backgroundImage: `url('/assets/images/phantom-africa-image2.jpg')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Reveal delay={0.1} direction="right">
              <motion.div
                ...
                className="bg-blue-50 backdrop-blur-xl border border-primary/30 p-10 md:p-14 rounded-3xl h-full flex flex-col relative overflow-hidden group shadow-[0_8px_30px_rgb(249,115,22,0.1)]"
              >
                ...
                <p className="text-lg text-gray-900 font-light leading-relaxed relative z-10">
            ...
            <Reveal delay={0.2} direction="left">
              <motion.div
                whileHover={{ scale: 1.02 }}
                className="bg-blue-50 backdrop-blur-xl border border-secondary/30 p-10 md:p-14 rounded-3xl h-full flex flex-col relative overflow-hidden group shadow-[0_8px_30px_rgb(37,99,235,0.1)]"
              >
                <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:opacity-20 transition-opacity">
                  <Eye size={120} />
                </div>
            ...
            <Reveal key={step.title} delay={i * 0.15}>
              <div className="relative z-10 flex flex-col items-center text-center group">
                <div className="w-16 h-16 rounded-xl bg-white/5 backdrop-blur-md border border-white/20 flex items-center justify-center mb-6 group-hover:bg-white group-hover:text-dark-900 transition-all duration-300">
                  <span className="absolute top-5 -left-5 text-sm font-display font-bold text-gray-500 group-hover:text-primary transition-colors">
                    0{i + 1}
                  </span>
                  <step.icon size={28} />
                </div>
